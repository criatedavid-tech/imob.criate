...
export default function Login() {
  ...
  return (
    <div className="min-h-screen app-bg flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans relative overflow-hidden">
      {/* Noise texture */}
      ...
      >
        ...
        <h2 className="text-center text-3xl font-extrabold text-[var(--text-hi)] tracking-tight">
          Bem-vindo de volta
        </h2>
      ...
      >
        <div className="py-10 px-8 rounded-3xl
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            {/* E-mail */}
            <div>
              <label className="block text-[10px] font-bold text-[var(--text-low)] mb-1.5 uppercase tracking-widest pl-1">
                E-mail
              </label>
              <div className="relative">
                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-[var(--text-low)] pointer-events-none" />
                <input
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link to="/forgot-password" className="text-xs text-[var(--text-low)] hover:text-violet-300 transition-colors">
                  Esqueceu a senha?
                </Link>
              </div>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-[var(--text-low)] pointer-events-none" />
                <input
            ...
            <button type="submit" disabled={loading}
              className="w-full h-14 flex justify-center items-center gap-2 rounded-2xl text-base font-bold text-[var(--text-hi)]
