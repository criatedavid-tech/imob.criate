    ...
    <div className="min-h-screen app-bg flex items-center justify-center p-6 font-sans relative overflow-hidden">
      ...
      <motion.div
        ...
        className="relative z-10 max-w-md w-full text-center rounded-[40px] p-10
          backdrop-blur-2xl bg-white/12 border border-[var(--glass-border)]
      ...
      >
        ...
        <h1 className="text-2xl font-black text-[var(--text-hi)] mb-2">Bem-vindo!</h1>
        <p className="text-lg font-semibold text-[var(--text-hi)] mb-3">Pagamento confirmado com sucesso</p>
        <p className="text-[var(--text-low)] leading-relaxed mb-6 text-sm">
        ...
        <div className="rounded-2xl p-4 mb-6 flex items-center justify-center gap-2
          backdrop-blur-md bg-[var(--control-fill-hover)] border border-[var(--glass-border)]">
          <Loader2 className="animate-spin w-4 h-4 text-[var(--text-low)]" />
          <span className="text-sm text-[var(--text-mid)]">
            Acessando o dashboard em <strong className="text-[var(--text-hi)]">{countdown}s</strong>...
          </span>
        </div>
        ...
        <button
          ...
          className="w-full h-12 flex items-center justify-center gap-2 rounded-2xl text-sm font-bold text-[var(--text-hi)]
